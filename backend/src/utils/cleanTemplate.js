...
function processTemplateFile() {
  try {
    ...
    xml = replaceParagraphText(xml, /Sanoatlashgan intensiv bog‘ tashkil qilish uchun/i, '{bog_title_label} tashkil qilish uchun');

    xml = replaceParagraphText(xml, /Toshkent\s*-\s*2026/i, 'Toshkent - 2026');
